...
class FilterNewsFeedWidget extends StatefulWidget {
  ...
  FilterNewsFeedWidget({this.length, required this.itemBloc, required this.mainScreenInstance});

  @override
  _FilterNewsFeedWidgetState createState() => _FilterNewsFeedWidgetState();
}

class _FilterNewsFeedWidgetState extends State<FilterNewsFeedWidget> {
  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => widget.itemBloc,
      child: BlocBuilder<FilterCategoryBloc, ItemState>(
